            ...
            {data.allFormations &&
              data.allFormations.map((formation, idx) => (
                <tr key={idx}>
                  ...
                  <td className='col-1'>{formation.intitule}</td>
                  <td className='col-1'>{formation.duree_formation}</td>
                  <td className='col-1'>{formation.horaire_formation}</td>
                  <td className='col-1'>{formation.nbre_min_part}</td>
                  <td className='col-1'>{formation.nbre_max_part}</td>
                  <td className='col-1'>{formation.description_formation}</td>
                  <td className='col-1'>{formation.catagorie_formation}</td>
                  <td className='col-1'>{formation.prix_formation}</td>
                  <td className='col-1'>{formation.prerequis}</td>
                  <td className='col-1'>{formation.participant}</td>
                  <td className='col-1'>
