...
module.exports = (sequelize, DataTypes) => {
  const Formateur = sequelize.define(
    "Formateur",
    {
      ...
      classe_f: { allowNull: false, type: DataTypes.STRING(10) },
      fonction_f: { allowNull: false, type: DataTypes.STRING(20) },
      cv_f: { allowNull: false, type: DataTypes.STRING },
      email_f: {
        allowNull: false,
